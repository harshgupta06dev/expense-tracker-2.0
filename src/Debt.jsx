...
export default function DebtTracker() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex justify-center">
      <div
        className="w-full max-w-[1300px] px-4 sm:px-6 lg:px-8 pt-4 pr-4 pl-4 pb-1
"
      >
        {/* Header */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
          <div className="bg-green-500 rounded-xl p-4">
            ...
            <p className="text-white/70 text-xs mt-1">
              {activeDebts.filter((d) => d.type === "owed_to_me").length} people
              owe you
            </p>
          </div>
                ...
                <div className="bg-slate-700/50 rounded-lg p-4">
                  ...
                  <div className="flex justify-between text-sm font-semibold mt-2 pt-2 border-t border-slate-600">
                    ...
                    <span className="text-amber-400">
                      $
                      {(
                        selectedDebt.amount - selectedDebt.paid
                      ).toLocaleString()}
                    </span>
                  </div>
                </div>
